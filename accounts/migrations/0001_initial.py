    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('balance', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0'), editable=False, max_digits=14, validators=[djmoney.models.validators.MinMoneyValidator(0)], verbose_name='Balance')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delta', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0'), max_digits=14, validators=[djmoney.models.validators.MinMoneyValidator(djmoney.money.Money(0, currency='USDT'))], verbose_name='Delta')),
                ('comment', models.TextField(blank=True, verbose_name='Comment')),
                ('object_id', models.IntegerField(blank=True, null=True, verbose_name='Awarded/payed for question/answer id')),
                ('account', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.PROTECT, to='accounts.account')),
                ('content_type', models.ForeignKey(blank=True, limit_choices_to=models.Q(models.Q(('app_label', 'questions'), ('model', 'question')), models.Q(('app_label', 'answers'), ('model', 'answer')), _connector='OR'), null=True, on_delete=django.db.models.deletion.SET_NULL, to='contenttypes.contenttype')),
            ],
            options={
